package day_10self.demo9_OutputStreamWriter;
...
public class Test {
    public static void main(String[] args) {
        ...
        try (
                ...
                OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream("C:\\Users\\Rescale\\Desktop\\basic\\JavaSE\\input\\gbk.txt",true), "utf8");
            ){
            // 写字符数据
            osw.write("中国你好");
        } catch (IOException e) {
